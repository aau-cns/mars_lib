                                   ...
                                   const BufferDataType& data)
{
  ...
  else
  {
    ...
    {
      std::cout << "Warning: Measurement is older than oldest core state. Discarding measurement. "
    ...
    if (found_latest_init_state)
    {
      ...
      {
        std::cout << "Warning: Measurement is older than latest INIT state. Discarding measurement. "
